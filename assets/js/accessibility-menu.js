/*
 * ============================================================
 *  Rasiel Moser Attribution License 1.0
 * ============================================================
 *
 *  Copyright © 2026 Rasiel Moser
 *  Original Author: Rasiel Moser
 *
 *  Permission is granted to use, modify and redistribute this
 *  software for private and commercial purposes, provided that
 *  attribution to Rasiel Moser is retained.
 *
 *  The author attribution, copyright notice and license notice
 *  may not be removed, concealed or replaced.
 *
 *  Modified versions must continue to identify Rasiel Moser
...
const accessibilityMenuStyles = `
    ...
    #accessibility-modal.top #Schließen {
      top: 0;
      left: 0;
      margin: 15px;
    }
    ...
    #accessibility-modal.bottom #Schließen {
      top: 0;
      left: 0;
      margin: 15px;
    }
    ...
    #accessibility-modal #Schließen svg {
      width: 40px;
      height: 40px;
    }
    
    #accessibility-modal.close #Schließen svg {
      width: 40px;
      height: 40px;
    }
    ...
    #accessibility-modal.top #headerContent {
      margin: 10px 10px 10px 70px;
    }
    
    #accessibility-modal.bottom #headerContent {
      margin: 10px 10px 10px 70px;
    }
  ...
  #accessibility-modal .acc-child p{
    ...
    #change-positions button {
      ...
      margin: 0;
      border-radius: var(--border_radius);
      box-shadow: inset 0 0 0 2px #3c0080
    }
    ...
    .hide-images img,
    .hide-images #banner .image img,
    .hide-images #banner .image.object img {
      display: none !important;
    }

    .hide-images #banner .image,
    .hide-images #banner .image.object {
      display: none !important;
    }
    ...
    @media (max-width: 1024px) {
      #change-positions { display: none !important; }
      #change-cursor { display: none !important; }
      #accessibility-modal,
      #accessibility-modal.top,
      #accessibility-modal.bottom {
        top: auto !important;
  ...
  .underline-style-0 #sidebar #menu a {
    text-decoration: none;
    background: black !important;
    color: yellow !important;
    font-weight: bolder;
  ...
  .underline-style-1 #sidebar #menu a {
    text-decoration: none;
    background: #FFD740 !important;
    color: #005A9C !important;
    font-weight: bolder;
  ...
  .underline-style-2 #sidebar #menu a {
    text-decoration: none;
    background: white !important;
    color: black !important;
    font-weight: bolder;
  ...
  .underline-style-0 #sidebar #menu a:hover,
  .underline-style-1 #sidebar #menu a:hover,
  .underline-style-2 #sidebar #menu a:hover {
    text-decoration: underline !important;
  }

  /* wichtig: Sidebar Toggle NIE highlighten */
  .underline-style-0 #sidebar a.toggle,
  .underline-style-1 #sidebar a.toggle,
  .underline-style-2 #sidebar a.toggle {
...
const accessibilityMenuHTML = `
    <div id="accessibility-modal" class="top close" style="z-index: 9999;">
   <button id="Schließen" style="
        z-index: 9999;
        display: flex;
        justify-content: center;
        border: none;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function accessibilityModalOpenCloseToggle() {
      ...
      Schließen.innerHTML = accessibilityModal.classList.contains('close') ? 
    ...
    stroke="#131fa0" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // Mobile: lock menu to bottom-right and hide position controls
    const mobileMQ = window.matchMedia('(max-width: 768px)');
    function enforceMobileBottomRight() {
        if (!mobileMQ.matches) return;
        accessibilityModal.classList.remove('top');
        accessibilityModal.classList.add('bottom');

        const posBar = document.getElementById('change-positions');
        if (posBar) posBar.classList.add('hidden');

        positionActiveStatus();
    }

    // run once and whenever viewport crosses the breakpoint
    enforceMobileBottomRight();
    if (typeof mobileMQ.addEventListener === 'function') {
        mobileMQ.addEventListener('change', enforceMobileBottomRight);
    } else if (typeof mobileMQ.addListener === 'function') {
        mobileMQ.addListener(enforceMobileBottomRight);
    }
    ...
    alignAccTop.addEventListener('click', () => {
        if (mobileMQ.matches) { enforceMobileBottomRight(); return; }
        accessibilityModalOpenCloseToggle();
    ...
    function positionActiveStatus() {
        if (accessibilityModal.classList.contains('top')) {
    ...
    document.querySelector('#saturation').addEventListener('click', () => {
        ...
        if (saturationClickCount === 2) {
            ...
            item.querySelector('p').innerText = 'Farbsättigung';
            ...
            if (saturationClickCount === 0) {
                ...
                item.querySelector('p').innerText = 'Niedrige Farbsättigung';
                ...
                item.querySelector('p').innerText = 'Hohe Farbsättigung';
                item.querySelector('.acc-progress-parent').classList.remove('hidden');
    ...
    document.querySelector('#font-size').addEventListener('click', () => {
        ...
        if (fontSizeClickCount === 3) {
            ...
            if (fontSizeClickCount === 0) {
                docElement.style.fontSize = '1.125rem';
                item.querySelector('.acc-progress-parent').classList.remove('hidden');
                item.querySelector('.acc-progress-child-1').classList.add('active');
                item.querySelector('.acc-progress-child-2').classList.remove('active');
                item.querySelector('.acc-progress-child-3').classList.remove('active');
            } else if (fontSizeClickCount === 1) {
                docElement.style.fontSize = '1.25rem';
                item.querySelector('.acc-progress-parent').classList.remove('hidden');
                item.querySelector('.acc-progress-child-1').classList.remove('active');
                item.querySelector('.acc-progress-child-2').classList.add('active');
                item.querySelector('.acc-progress-child-3').classList.remove('active');
            } else if (fontSizeClickCount === 2) {
                docElement.style.fontSize = '1.375rem';
                item.querySelector('.acc-progress-parent').classList.remove('hidden');
                item.querySelector('.acc-progress-child-1').classList.remove('active');
                item.querySelector('.acc-progress-child-2').classList.remove('active');
                item.querySelector('.acc-progress-child-3').classList.add('active');
    ...
    function saveSettings() {
        localStorage.setItem('accessibility-settings', JSON.stringify({
            ...
            accPosition: accessibilityModal.classList.contains('bottom') ? 'bottom' : 'top'
        }));
    }
    ...
    if (savedSettings) {
        ...
        //remove position classes of the accessibility modal
        accessibilityModal.classList.remove('top');
        accessibilityModal.classList.remove('bottom');

        //set the position of the accessibility modal (legacy: 'right' -> 'top')
        const savedPos = savedSettings.accPosition;
        const pos = savedPos === 'bottom' ? 'bottom' : 'top';
